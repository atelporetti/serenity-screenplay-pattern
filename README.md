...
## The Screenplay swaglabs project
If you prefer to use the Screenplay pattern, or want to try it out, check out the _screenplay_ branch instead of the _master_ branch. In this version of the swaglabs project, the same scenario is implemented using the Screenplay pattern. 
